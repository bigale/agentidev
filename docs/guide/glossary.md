...
**Enterprise Tier** — Same bridge server deployed to a cloud VM. Web UI served at `http://host:9876/`. No Chrome extension needed. Same 21 tools, same pipeline, WebSocket transport instead of chrome.runtime.
