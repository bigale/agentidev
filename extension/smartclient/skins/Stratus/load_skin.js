...
//----------------------------------------
    ...
    isc.Media.setStockIconStates(['Header_Close'], ["Over", "Disabled"]);
    ...
    if (isc.ListGrid) {
        isc.ListGrid.addProperties({
            ...
            sortAscendingImage:{src:"[SKINIMG]ListGrid/sort_ascending.png", width:10, height:7},
            sortDescendingImage:{src:"[SKINIMG]ListGrid/sort_descending.png", width:10, height:7},
