...
// -------------------------------------------------------------
// Agentidev patch (2026-04): chrome.runtime.getPackageDirectoryEntry
// is a deprecated MV2 API that never fires its callback in MV3. Force
// the DirectDownloader (XHR) fall-through path for all requests, even
// inside chrome-extension origin. XHR to extension resources works via
// web_accessible_resources.
// -------------------------------------------------------------
var controlPort = null;
var packagePromise = null;
var extensionUrlPrefix = null;
// (Original chrome.runtime package-directory-entry setup removed;
//  see STATUS.md and git history.)
