#!/usr/bin/env node
/**
 * Auto-generated API test: POST /pet/{petId}/uploadImage
...
const client = new ScriptClient('test-petstore-uploadFile', { totalSteps: 25 });

const cases = [
  {
    "petId": "1",
    "additionalMetadata": "doggie",
  ...
  {
    "petId": "9999",
    "additionalMetadata": "~empty_string",
    "Accept": "application_json",
    "Auth": "valid_auth",
    "_negative": true
  },
...
function buildPath(c) {
  return `/pet/${stripNeg(c.petId)}/uploadImage`;
}


try {
  await client.connect();
  console.log('POST /pet/{petId}/uploadImage — ' + cases.length + ' test cases');
  console.log('==================================================\n');
