#!/usr/bin/env node
/**
 * Auto-generated API test: DELETE /store/order/{orderId}
...
const client = new ScriptClient('test-petstore-deleteOrder', { totalSteps: 8 });
...
try {
  ...
  console.log('DELETE /store/order/{orderId} — ' + cases.length + ' test cases');
  console.log('==================================================\n');
